    ...
    <>
        ...
        >
          ...
          <div className="flex-shrink-0 flex items-center gap-2 ml-auto">
            ...
            <button
              ...
              aria-label="Menú"
              className="md:hidden w-10 h-10 flex items-center justify-center rounded-full text-[#F5C842] cursor-pointer"
              style={{
      ...
      {open && (
        <div
          ...
          style={{ background: 'rgba(24,4,18,.97)', backdropFilter: 'blur(8px)' }}
        >
          <button
          ...
          {LINKS.map((l) => (
            <a
              ...
              href={l.href}
              onClick={() => setOpen(false)}
              className="text-[#F0EDE8] no-underline"
              style={{ fontFamily: 'var(--font-skatyn), serif', fontSize: 30, padding: '12px' }}
            >
              {l.label}
            </a>
          ))}
