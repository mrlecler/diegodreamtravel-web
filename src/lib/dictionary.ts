...
const es = {
  ...
  why: {
    ...
    app: {
      ...
      phone: {
        greeting: 'Tu viaje',
        tripName: 'Walt Disney World',
        countdown: 'Faltan 12 días',
        live: 'EN VIVO',
        items: [
          { time: '08:40', label: 'Vuelo EZE → MCO' },
          { time: '15:00', label: 'Check-in · Hotel' },
          { time: '18:30', label: 'Magic Kingdom' },
        ],
  ...
  why: {
    ...
    app: {
      ...
      phone: {
        ...
        live: 'LIVE',
        items: [
          { time: '08:40', label: 'Flight EZE → MCO' },
          { time: '15:00', label: 'Hotel check-in' },
          { time: '18:30', label: 'Magic Kingdom' },
        ],
        pushTitle: 'Diego · Dream Travel',
