...
export default function D15Footer() {
  return (
    <footer
      style={{
        background: '#0D0514',
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center gap-2 text-[13px] text-[rgba(240,237,232,.6)] no-underline hover:text-[#25D366] transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center gap-2 text-[13px] text-[rgba(240,237,232,.6)] no-underline hover:text-[#E1306C] transition-colors"
              >
                {IG_ICON} @diego.dreamtravel
              </a>
              <a
                href="mailto:info@diegodreamtravel.com"
                className="text-[13px] text-[rgba(240,237,232,.6)] no-underline hover:text-[#F0EDE8] transition-colors"
              >
